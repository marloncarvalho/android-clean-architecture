...
abstract class RxUseCase<out Type, in Params> where Type : Any {
    ...
    abstract class RxSingle<T, in P> : RxUseCase<Single<T>, P>() {
    ...
    abstract class RxObservable<T, in P> : RxUseCase<Observable<T>, P>() {
    ...
    abstract class RxFlowable<T, in P> : RxUseCase<Flowable<T>, P>() {
    ...
    abstract class RxCompletable<in P> : RxUseCase<Completable, P>() {
